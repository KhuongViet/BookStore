   ...
   <div class="footer">
	     ...
	     <div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>Liên hệ</h4>
						<ul>
							<li><span>0368 752 417</span></li>
							<li><span>0963 452 168</span></li>
						</ul>
						<div class="social-icons">
							<h4>Theo chúng tôi</h4>
					   		  <ul>
							      <li class="facebook"><a href="https://www.facebook.com/" target="_blank"> </a></li>
							      <li class="twitter"><a href="https://x.com/" target="_blank"> </a></li>
							      <li class="googleplus"><a href="https://www.google.com.vn/?hl=vi" target="_blank"> </a></li>
							      <li class="contact"><a href="https://www.google.com/intl/vi/gmail/about/" target="_blank"> </a></li>
							      <div class="clear"></div>
						     </ul>
   	 					</div>
				</div>
			...
			<div class="copy_right">
				<p>Books Store Online &amp; Bảo lưu mọi quyền </p>
		   </div>
     </div>
    </div>
